...
from database.database_mappings import (CandidateOffice,
                                        IncumbentChallengerStatus,
                                        CandidateStatus)


# Candidate Master - contains one record for each candidate who has either
# registered with the Federal Election Commission or appeared on a ballot list
# prepared by a state election's office.
class Candidate(Model):
    ...
    candidate_principal_campaign_committee = fields.CharField(max_length=9,
                                                              null=True)
